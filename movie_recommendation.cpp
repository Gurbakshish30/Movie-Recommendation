...
graph comedygraph;
graph thrillergraph;
movie movie1("The Shawshank Redemption", "Frank Darabont", "1994", {"Tim Robbins", "MorganFreeman"}, {4, 2, 8, 1} , true);
...
3, 8, 2} , true);
movie movie5("Inception", "Christopher Nolan", "2010", {"Leonardo DiCaprio", "Joseph GordonLevitt"}, {9, 2, 7, 4} , true);
movie movie6("Interstellar", "Christopher Nolan", "2014", {"Matthew McConaughey", "AnneHathaway"}, {8, 2, 8, 3} , true);
movie movie7("Due Date", "Todd Phillips", "2010", {"Robert Downey Jr.", "Zach Galifianakis"}, {6, 7,
5, 4});
movie movie8("21 Jump Street", "Phil Lord, Christopher Miller", "2012", {"Jonah Hill", "ChanningTatum"}, {8, 7, 5, 3});
...
1});
movie movie22("Don't Look Up", "Adam McKay", "2021", {"Leonardo DiCaprio", "JenniferLawrence"}, {7, 6, 6, 3});
...
cout << " $$ | $$ |$$ | $$ | $$ |\\$ /$$ |$$ | $$ | \\$$$ / $$ |$$ ____|\\____$$\\ " << endl;
cout << " \\$$$$$$ |\\$$$$$$ | $$ | \\_/ $$ |\\$$$$$$ | \\$ / $$ |\\$$$$$$$\\$$$$$$$ |" << endl;
cout << " \\______/ \\______/ \\__| \\__| \\______/ \\_/ \\__|\\_______|\\_______/ " << endl;
cout << endl;
cout<<RESET<<endl;
cout<<"----------------------------------------------------------------------------------------------------------------------------\n"<<endl;
cout<<YELLOW<<" Welcome to Go Movies: Your Gateway to Unforgettable MovieAdventures! "<<RESET<<endl;
cout<<" Get a movie recommended based on your preferences :-\n";
cout<<CYAN<<" We suggest you the best movies based on preferences of movies thatyou give us !!\n"<<RESET;
while (1){
